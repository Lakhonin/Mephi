...
INSERT INTO Издание_E3(id_publication,id_author,title,number_pages,year_publication,count_publication)
VALUES ('14','4','Краткая история','456','1992','0'),
('7','3','История Руси','734','2010','0'),
('8','6','Математика','523','2019','0'),
('13','8','Астрономия','643','2018','0');

INSERT INTO Издание_E3(id_publication,id_author,title,number_pages,year_publication,annotation,count_publication)
...
('2','Библио','734534','830159, Кировская область, город Дмитров, бульвар Ленина, 56','3_456_314_95_82','Виктор','Зиновий','Алексеевич'),
...
('6','Элипс','7345234','583158, Владимирская область, город Луховицы, проезд Космонавтов, 18','2_319_745_33_33','Давид','Фролов','Витальевич'),
...
('2','Кафедра 3','История','Арсений','Соболев','Нинель','Кирилл','Терентьев','Олегович'),
('3','Кафедра 2','ИТ','Севастьян','Евдокимов','Вадимович','Георгий','Воробьёв','Митрофанович'),
...
INSERT INTO Заявка_E8(id_task,id_employee,id_chair,date_task)
VALUES ('12','11','2','02.12.2021'),
('15','4','2','04.9.2021'),
('16','3','4','03.6.2021'),
('17','2','5','06.8.2021'),
('18','6','3','09.4.2021'),
...
INSERT INTO Планы_издательств_E11(id_plans_publishing,id_employee,id_publishing)
VALUES ('1','4','1'),
('2','5','5'),
('3','3','7'),
('4','2','6'),
...
INSERT INTO Издаваемая_литература_E13(id_publication,id_plans_publishing,count_publication,date_plans)
VALUES ('2','2','600','2021'),
('11','5','30','2022'),
('8','2','300','2020'),
('4','3','450','2022'),
